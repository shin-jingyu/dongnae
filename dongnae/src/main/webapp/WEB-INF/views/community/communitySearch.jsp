...
<div  style="max-height: calc(100vh - 200px); overflow-x: hidden; overflow-y: auto;  width: 75%; float: right; box-sizing: border-box;">
	 ...
	 <p class="text-dark fw-bold">검색결과</p>
	<div class="card border-dark mb-3 " >
 	...
 	<div  style="margin:auto;">
		 ...
		 <ul class="pagination">
			...
			<c:if test="${page.prev}">
			 <li class="page-item">
	      		<a class="page-link" href="/community/communitySearch?num=${page.startPageNum - 1}${page.searchTypeKeyword}" aria-label="Previous">
			...
			<c:if test="${page.next}">
				<li class="page-item">
			    	<a class="page-link" href="/community/communitySearch?num=${page.endPageNum + 1}${page.searchTypeKeyword}" aria-label="Next">
