...
<div class="card shadow" style="margin-top:40px;" >
	...
	<div  style="margin:auto;">
		 ...
		 <ul class="pagination">
			...
			<c:if test="${page.prev}">
			 <li class="page-item">
	      		<a class="page-link" href="/community/pageCategory?ca_l=${page.ca_l}&num=${page.startPageNum - 1}" aria-label="Previous">
			...
			<c:if test="${page.next}">
				<li class="page-item">
			    	<a class="page-link" href="/community/pageCategory?ca_l=${page.ca_l}&num=${page.endPageNum + 1}" aria-label="Next">
